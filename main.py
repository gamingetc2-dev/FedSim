...
FOMC_DATES_BY_ERA = {
    ...
    "powell": {
        ...
        "2024-06","2024-07","2024-09","2024-11","2024-12","2025-01","2025-03",
    },
}
...
def load_or_build():
    ...
    with open(CACHE_FILE, "w") as f:
        json.dump(panel_records.to_dict(orient="records"), f)
...
def refresh_data():
    ...
    if IRF_FILE.exists():   IRF_FILE.unlink()
    try:
        load_or_build()
...
def index():
    ...
    resp = make_response(send_from_directory(str(ROOT), "index.html"))
